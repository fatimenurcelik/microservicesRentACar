...
public class CarController {
	...
	@PutMapping("/{id}")
	public UpdateCarStateResponse updateCarState(@PathVariable String id, int state) {
		return carService.updateCarState(id, state);
	}
	
	@GetMapping("/{id}")
	public void checkCarAvailabel(@PathVariable String id) {
		carService.checkCarAvailabel(id);
	}
}
